...
具体的细节可以参见Java版本的[持久化](/doc/2.8.0/java/Persistence.md#_1-ignite持久化)文档。
### 1.1.用法
...
<Tab title="CacheJdbcBlobStoreFactory">
...
<Tab title="CacheHibernateBlobStore">
